(function ($) {
  ...
  Drupal.behaviors.vestidor = {
    attach: function(context, settings) {
      var top = $('#region-sidebar-second').offset().top;
      var top = $('#region-sidebar-second').offset().top - $('#region-sidebar-second').css('marginTop');
      var top = $('#region-sidebar-second').offset().top - parseFloat($('#region-sidebar-second').css('marginTop'));
      //var top = $('#region-sidebar-second').offset().top - parseFloat($('#region-sidebar-second').css('marginTop').replace(/auto/,0));
